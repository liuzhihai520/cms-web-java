...
<head>
  ...
  <script src="static/javascript/menu/menu_add.js"></script>
</head>
    ...
    <div class="col-xs-12">
        ...
        <form action="menu/addMenu" class="form-horizontal" role="form" id="form" name="form" method="post" target="hidden_frame">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-4">
                    <input type="text" id="resName" name="name" placeholder="请输入菜单名称" class="form-control"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-4">
                    <input type="text" id="resKey" name="resKey" placeholder="请输入菜单标识" class="form-control"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-4">
                    <input type="text" id="resURL" name="url" placeholder="请输入菜单URL" class="form-control"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-4">
                    <input type="text" id="resIcon" name="icon" placeholder="请输入icon" class="form-control"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-4">
                  <input type="text" id="description" name="description" placeholder="请输入菜单描述" class="form-control"/>
                </div>
            </div>
